...
<div class="card-header">
 ...
 <!--<form action="request.php"  method="POST" >  id="payment-form" -->
    <div class="card-body">
		<div class="container-fluid">
        <div class="row justify-content-center">
            <div class="col-md-10 mb-5">
                ...
                <form action="request.php" id="payment-form" method="POST" > 
                    ...
                    <input type="hidden" name="total[]"> -->
                    <tr>
            <div class="text-right py-1 px-2" colspan="4" name="totalprice">Total</div>
            <div class="text-right py-1 px-2 grand-total"><?php echo isset($amount) ? number_format($amount,2) : 0 ?></div>
       
                     <div class="form-group col-6">
                        <label for="name">Name</label>
                            <input type="text" name="agentName" class="form-control" placeholder="Enter your name" required>
                    </div>
                    <div class="form-group col-6">
                        <label for="name">Email</label>
                            <input type="email" name="agentEmail" class="form-control" placeholder="Enter your email" required>
                    </div>
                    <div class="form-group col-6">
                    <label for="name">Phone Number</label>
                    <input type="phone" name="agentPhone" class="form-control" placeholder="Enter your telephone number" required>
                    <a class="btn btn-flat btn-dark" href="<?php echo base_url.'/admin?page=payment' ?>">Checkout to toyyibPay page bismillah..</a>

                         <!-- <button class="btn btn-flat btn-primary" type="submit">Checkout to toyyibPay page bismillah..</a>  -->
                        </div>
                </form> 
