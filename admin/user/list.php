				...
				<tbody>
					...
					?>
						<tr>
							...
							<!-- <td class="text-center"><img src=" " class="img-avatar img-thumbnail p-0 border-2" alt="avatar"></td> -->
							<!-- <td class="text-center"><img src="<?php echo validate_image($row['avatar']) ?>" class="img-avatar img-thumbnail p-0 border-2" alt=" "></td> -->
							<td><?php echo ucwords($row['name']) ?></td>
							<td ><p class="m-0 truncate-1"><?php echo $row['username'] ?></p></td>
							<td ><p class="m-0"><?php echo ($row['type'] == 1 )? "Manager" : "Agent" ?></p></td>
							<!-- <td align="center"> -->
							<td>
