...
<div class="card card-outline card-primary">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="supplier_id" class="control-label text-info">Category</label>
    ...
    <div class="card-footer py-1 text-center">
        <button class="btn btn-flat btn-primary" type="submit" form="po-form">Place Order</button> 
        /*jadikan payment. Save -> place order. go to page payment */
